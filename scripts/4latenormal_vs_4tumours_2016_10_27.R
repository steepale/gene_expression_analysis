targets <- read.delim("targets_4late_4tumour.txt", stringsAsFactors=FALSE)
...
samples <- c("017936", "017939", "017945", "017947", "017738-1", "017741-1", "017766-1", "017777-3")
...
NvsT <- makeContrasts(NC.Normal-Tu.Tumour, levels=design)

res <- glmQLFTest(fit, contrast=NvsT)
